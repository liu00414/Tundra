let app = {
    ...
    init: function () {
        ...
        sessionStorage.getItem(app.KEY) ? app.favsData = JSON.parse(sessionStorage.getItem(app.KEY)) : sessionStorage.setItem(app.KEY, JSON.stringify(app.favsData));
        app.getData();
    ...
    makeCards: function (profiles) {
        ...
        profiles.forEach((profile) => {
            ...
            card.className = 'card top active';
    ...
    makeFavsCards: function () {
        ...
        if (app.favsData.length != 0) {
            ...
            document.getElementById('favs').innerHTML = '';
            document.getElementById('favs').innerHTML = '<p>There is no favourites to show!</p>';
        };
